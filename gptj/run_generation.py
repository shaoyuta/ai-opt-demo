...
parser.add_argument("--enable-xpu-optimize", action="store_true")
...
config = AutoConfig.from_pretrained(
    args.model_id, torchscript=args.jit
)
...
if not args.enable_xpu_optimize:
